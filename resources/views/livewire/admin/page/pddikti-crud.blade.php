                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                        <tr>
                            ...
                            <th class="px-6 py-3 w-1/3">Tugas / Fungsi</th>
    ...
    <div x-show="openModal" x-transition x-cloak
        ...
        <div
            ...
            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">
                {{ $labId ? 'Edit Data PDDIKTI' : 'Tambah Data PDDIKTI' }}
            </h3>
            ...
            <form wire:submit.prevent="store" class="space-y-3">
                <div class="grid grid-cols-1 gap-3">
                    {{-- Judul --}}
                    <div>
                        <label class="block text-base font-medium text-gray-800 dark:text-gray-200 mb-1">
                            Judul
                        </label>
                        <x-admin.form.inputText 
                            wire:model="judul"
                            placeholder="Masukkan judul data PDDIKTI"
                    ...
                    <div>
                        ...
                        <x-admin.form.textarea 
                            ...
                            placeholder="Tuliskan deskripsi data PDDIKTI"
                            rows="8"
                    ...
                    <div>
                        ...
                        <x-admin.form.textarea 
                            wire:model="tugas"
                            placeholder="Tuliskan tugas utama atau fungsi data"
                            rows="8"
                            class="text-base leading-relaxed"
                        />
                    </div>
