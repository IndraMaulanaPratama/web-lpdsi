<div class="p-6">
            ...
            <div class="bg-white w-[90%] md:w-[650px] rounded-2xl shadow-xl p-8 relative">
                ...
                <form wire:submit.prevent="save" class="space-y-6">
                    ...
                    <div>
                        ...
                        {{-- Hapus wire:change yang menyebabkan error sebelumnya --}}
    ...
    <div class="mt-10 space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            ...
            <div class="max-h-[300px] overflow-y-auto pt-2 pr-2">
                <div class="flex flex-wrap gap-4 justify-start">
                    @forelse($mitraDalam as $partner)
                        {{-- Mitra Card (Responsive Grid Item) --}}
                        <div class="flex-none w-28 h-28 text-center bg-gray-50 dark:bg-gray-700 rounded-lg shadow-md p-3 relative group">
                            <img src="{{ asset('storage/' . $partner->logo) }}" 
                                 class="w-full h-16 object-contain rounded p-1" 
                                 onerror="this.onerror=null; this.src='https://placehold.co/112x64/292524/EAEAEA?text=LOGO';"
                                 alt="Logo Mitra">
