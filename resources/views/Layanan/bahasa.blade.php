...
@section('title', 'Laboratorium Bahasa')
    ...
    <div class="container mx-auto max-w-5xl">
        ...
        <nav class="flex items-center text-gray-600 text-sm mb-10" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-2 md:space-x-3">
                ...
                <li class="text-blue-700 font-medium">Laboratorium Bahasa</li>
            </ol>
        </nav>

        {{-- Konten --}}
        <div class="bg-white/80 backdrop-blur-xl shadow-lg rounded-2xl p-10 border border-blue-50">
            <h1 class="text-4xl font-bold text-blue-900 mb-6">{{ $lab->judul ?? 'Laboratorium Bahasa' }}</h1>
            ...
            <h2 class="text-2xl font-semibold text-black-800 mb-4">Arsip File</h2>
            <ul class="list-disc list-inside text-gray-700 space-y-2">
                <li>
                    <a href="https://drive.google.com/drive/folders/1FCjWmc8s98t7_vxl5i2ItWRetOqsarm8/" target="_blank" class="text-blue-600 hover:underline">
                        Google Drive Arsip Laboratorium Bahasa
                    </a>
                </li>
            </ul>
        </div>
