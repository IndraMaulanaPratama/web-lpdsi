...
@section('title', 'Laboratorium PDDIKTI')
    ...
    <div class="container mx-auto max-w-5xl">
        <nav class="flex items-center text-gray-600 text-sm mb-10" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-2 md:space-x-3">
                ...
                <li class="text-blue-700 font-medium">Laboratorium PDDIKTI</li>
            </ol>
        </nav>

        <div class="bg-white/80 backdrop-blur-xl shadow-lg rounded-2xl p-10 border border-blue-50">
            <h1 class="text-4xl font-bold text-blue-900 mb-6">{{ $lab->judul ?? 'Laboratorium PDDIKTI' }}</h1>
